const CoffeeData = [
    {
      ...
      prices: [
        {size: 'P', price: '10,38', currency: 'R$'},
        {size: 'M', price: '13,15', currency: 'R$'},
        {size: 'G', price: '14,29', currency: 'R$'},
      ],
      average_rating: 4.7,
      ratings_count: '6,879',
      favourite: false,
    ...
    },
    {
      ...
      special_ingredient: 'Com Leite Vaporizado',
      prices: [
        {size: 'G', price: '10,38', currency: 'R$'},
        {size: 'M', price: '13,15', currency: 'R$'},
        {size: 'P', price: '14,29', currency: 'R$'},
      ],
      average_rating: 4.7,
      ratings_count: '6,879',
      favourite: false,
